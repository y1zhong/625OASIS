...
In order to classify dementia from CN, we applied the following four methods: penalized logistic regression (ridge and lasso), random forest, support vector machine (linear and radial kernel), native Bayes, and convolutional neural network (CNN).  
...
Given the high dimensional structure of our data, we ran into several problems during analysis
