...
**b) Random Forest**   
Random forests is an ensemble learning method. For classification tasks, its output is the class selected by most trees. It doesnt overfit with more features and its efficiency is particularly notable in large data sets.
